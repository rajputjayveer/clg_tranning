                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="left-image">
                                ...
                                <a href="/Propertydetails" ><img src="assets/images/featured-icon.png" alt="" style={{ maxWidth: '60px', padding: 0 }} /></a>
                            </div>
                        </div>
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div className="accordion-body">
                                            Get <strong>the best villa</strong> website template in HTML CSS and Bootstrap for your business. TemplateMo provides you the <a href="https://www.google.com/search?q=best+free+css+templates" target="_blank" rel="noreferrer">best free CSS templates</a> in the world. Please tell your friends about it.</div>
                                    </div>
                                </div>
                                <div className="accordion-item">
                    ...
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1">
                            <div className="video-frame">
                                ...
                                <a href="https://youtube.com" rel="nofollow noreferrer" target="_blank"><i className="fa fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-3">
                                                    ...
                                                    <div className="icon-button">
                                                        <a href="/Propertydetails"><i className="fa fa-calendar"></i> Schedule a visit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-01.jpg" alt="" /></a>
                                <span className="category">Luxury Villa</span>
                                <h6>$2.264.000</h6>
                                <h4><a href="/Propertydetails">18 New Street Miami, OR 97219</a></h4>
                                <ul>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-02.jpg" alt="" /></a>
                                <span className="category">Luxury Villa</span>
                                <h6>$1.180.000</h6>
                                <h4><a href="/Propertydetails">54 Mid Street Florida, OR 27001</a></h4>
                                <ul>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-03.jpg" alt="" /></a>
                                <span className="category">Luxury Villa</span>
                                <h6>$1.460.000</h6>
                                <h4><a href="/Propertydetails">26 Old Street Miami, OR 38540</a></h4>
                                <ul>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-04.jpg" alt="" /></a>
                                <span className="category">Apartment</span>
                                <h6>$584.500</h6>
                                <h4><a href="/Propertydetails">12 New Street Miami, OR 12650</a></h4>
                                <ul>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-05.jpg" alt="" /></a>
                                <span className="category">Penthouse</span>
                                <h6>$925.600</h6>
                                <h4><a href="/Propertydetails">34 Beach Street Miami, OR 42680</a></h4>
                                <ul>
                                    <li>Bedrooms: <span>4</span></li>
                                    <li>Bathrooms: <span>4</span></li>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="item">
                                <a href="/Propertydetails"><img src="assets/images/property-06.jpg" alt="" /></a>
                                <span className="category">Modern Condo</span>
                                <h6>$450.000</h6>
                                <h4><a href="/Propertydetails">22 New Street Portland, OR 16540</a></h4>
                                <ul>
